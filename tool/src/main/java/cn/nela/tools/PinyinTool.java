...
public class PinyinTool {
    ...
    private static PinyinTool sInstance;
    ...
    protected PinyinTool(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static PinyinTool getInstance() {
        synchronized (PinyinTool.class) {
            if (sInstance != null) {
                return sInstance;
            }
            ...
            sInstance = new PinyinTool(false);
            return sInstance;
        }
    }
